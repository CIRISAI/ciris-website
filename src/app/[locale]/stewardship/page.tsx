// Localized interim stub (/es/stewardship, …). Renders the shared SafetyStub in the
...
export async function generateMetadata({
  ...
  return localizedSeo("/stewardship", locale);
}
...
export default async function Page({
  ...
  return <SafetyStub variant="stewardship" t={getDictionary(resolved)} locale={resolved} />;
}
