        ...
        <div className="mx-auto max-w-4xl px-6 pt-44 pb-16">
          ...
          <div className="mb-12 rounded-lg border-4 border-green-500 bg-gradient-to-br from-green-50 to-blue-50 p-8 text-center shadow-xl dark:from-green-900/20 dark:to-blue-900/20">
            ...
            <p className="mb-6 text-lg text-gray-700 dark:text-gray-300">
              Your personal auditable AI agent, now on mobile. Private, local-first, and fully open source.
            </p>
            ...
            <CardsSection
              cardsData={[
                ...
                },
                {
                  ...
                  copyText:
                    "Purchase credits securely through Stripe. $0.10/interaction. Only charged when daily free and trial credits are used up.",
                  logoSrc: "logoIcon",
                  logoAlt: "Brand logo icon",
                },
              ]}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">$0.10/interaction • Only used after free credits</p>
                </div>
              </div>
            </div>
          </div>
