...
const navigation: Navigation = {
  ...
  support: [
    ...
    { name: "Values", href: "/values", key: "values" },
  ...
  social: [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/cirisai/",
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61579664204012",
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/cirisethicalai/",
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/watch?v=q7KuByW65Tk",
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
