---
title: "Introduzione"
description: "CIRIS 1.3-RC2 è una proposta di allineamento ASI in fase di Release Candidate, aperta alla revisione avversariale. Il testo è completo — non rimangono sezioni incomplete; la matematica include le citazioni degli artefatti formali; gli Allegati F–I sono operazionalizzati. Lo stato finale è in attesa della validazione del ciclo vitale degli allegati, del completamento del programma di validazione empirica del Libro IX e di un esercizio completo di red-team. Le soglie numeriche, gli obiettivi di latenza e le quote di governance sono ancora in fase di revisione attiva."
---
